...
exports.TableModule = TableModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([table_entity_1.RestaurantTable])],
        providers: [table_service_1.RestaurantTableService],
        controllers: [table_controller_1.TableController],
        exports: [table_service_1.RestaurantTableService],
    })
], TableModule);
